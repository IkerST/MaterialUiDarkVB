...
'-- Made By: IkerST ikersanditrejo@gmail.com
'-- License: GNU GPL V3
...
Class FlatBack : Inherits Control
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        With G
            ...
            '-- <
            .DrawString("w", Font, New SolidBrush(TextColor), New Rectangle(0, 0, Width, Height), CenterSF)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- if ShowText
            If ShowText Then
                .DrawString(Text, Font, New SolidBrush(Color.FromArgb(0, 170, 220)), New Rectangle(16, 16, W, H), NearSF)
            End If
        End With
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(0, 170, 220)
    Private _TextColor As Color = Color.FromArgb(243, 243, 243)
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(60, 60, 60)
    Private _ProgressColor As Color = Color.FromArgb(0, 170, 220)
    Private _DarkerProgress As Color = Color.FromArgb(0, 170, 220)
...
#Region " Colors"
    ...
    Private _HoverColor As Color = Color.FromArgb(0, 170, 220)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        With G
            .Clear(Color.FromArgb(0, 170, 220))
            .SmoothingMode = 2
            .PixelOffsetMode = 2
            .TextRenderingHint = 5
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(60, 60, 60)
    Private _ButtonColor As Color = Color.FromArgb(0, 170, 220)
...
#Region " Colors"
    ...
    Private _SelectedColor As Color = Color.FromArgb(0, 170, 220)
...
#Region " Colors"
        ...
        Private CheckedColor As Color = Color.FromArgb(0, 170, 220)
        Private BorderColor As Color = Color.FromArgb(0, 170, 220)
...
#Region " Colors"
    ...
    Private BaseColor As Color = Color.FromArgb(60, 60, 60)
    Private _TrackColor As Color = Color.FromArgb(0, 170, 220)
    Private SliderColor As Color = Color.FromArgb(75, 75, 75)
    Private _HatchColor As Color = Color.FromArgb(0, 170, 220)
...
#Region " Colors"
    ...
    Private _RectColor As Color = Color.FromArgb(0, 170, 220)
